...
/** 
 * @brief prints out the elements of an array, one element per line
...
/**
 * @brief finds the max number in the array
 * @param a[] an array
...
/**
 * @brief finds the min number in the array
 * @param a[] an array
 * @param size the size of the array
...
/**
 * @brief finds the array's midpoint
 * @param max max of the array
 * @param min min of the array
 * @return subtracts the min from the max and divides by 2 to produce midpoint
 */
...
/**
 * @brief Get the count of values that are true for an inequality
 * @param a[] the array
 * @param size the size of the array
 * @param type the type of inequality i.e. EQ (=), LT (<), GE (>=)...
 * @param x compared value
 * @return the count of values that matches the inequality
 */
...
/**
 * @brief searches for a value in the array equal to a specific value
 * @param a[] the array 
 * @param size the size of the array
 * @param x  the specific value being compared with (midpoint)
 * @return returns index of array of a number is equal; otherwise, returns -1
 */
...
/**
 * @brief gets the sum of the array
 * @param a[] the array
 * @param size the size of the array
...
/**
 * @brief gets the average of the array
 * @param size the size of the array
 * @param sum the sum of the array's values
...
/**
 * @brief organizes the array using bubble sort
 * @param a[] the array
 * @param size the size of the array
 */
...
/**
 * @brief reverses the order by switching indexes 
 * of the array with patterns of n i.e. a[0] becoming a[n]
 * @param a[] the array
 * @param size the size of the array
 */
...
/**
 * @brief gets the median of the array
 * @param a[] the array
 * @param size the size of the array
...
/**
 * @brief counts number of even values
 * @param a[] the array 
 * @param size the size of the array
 * @return number of all even values
 */
...
/**
 * @brief counts number of odd values
 * @param a[] the array
 * @param size the size of the array
 * @return number of all odd values
 */
...
/**
 * @brief counts values that are divisible by a certain value (min)
 * @param a[] the array
 * @param size the size of the array
 * @param x the divisor
 * @return the number of divisible values
 */
