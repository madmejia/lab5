...
/** prints out the elements of an array, one element per line, mostly for debugging
 * @param a[] the array
 ...
 * @param a[] the array
 * @param size the size or length of the array
 * @return looks through array and returns largest number
 */
...
/** finds the minimum number in array
 * @param a[] the array
 * @param size the size or length of the array
 * @return looks through array and returns smallest number
 */
...
/** finds the midpoint in array
 * @param max maximum number, the return of find_max
 * @param min minimum number, the return of find_min
 * @return finds the range (max-min) and then divides by 2
 */
int find_mid(int max, int min){
	return (max - min)/2;
}

/** counts how many values are true for a certain inequality
 * @param a[] the array
 * @param size the size or length of the array
 * @param type LT (<), LE (<=), GT (>), GE (<=), E (=)
 * @param x value being compared to, in this case it's the mid point
 * @return the count of values that matches the given inequality
 */
...
/** finds if there is any value in the array equal to a certain value
 * @param a[] the array
 * @param size the size or length of the array
 * @param x value being compared to, in this case it's the mid point
 * @return this returns the index of array if there is a number equal
 * @return if no value is equal it returns -1
 */
 ...
 * @param a[] the array
 * @param size the size or length of the array
 * @return adds every value together and returns the sum
 */
 ...
 * @param size the size or length of the array
 * @param sum the sum of all values in the array
 * @return average of array by dividing sum by the amount of elements in array
 */
int find_average(size_t size, int sum){
	return (sum / size);
}

/** organizes the array using a bubble sort
 * @param a[] the array
 * @param size the size or length of the array
 */
...
/** reverses order of array by switching a[0] and a[n], a[1] and a[n+1] etc.
 * @param a[] the array
 * @param size the size or length of the array
 */
...
/** Now with the sorted list, it returns the median
 * @param a[] the array
 * @param size the size or length of the array
 * @return if size is even it finds the avg of the middle 2 values
 * @return if size is odd it find the middle value
 */
...
/** counts how many values are even
 * @param a[] the array
 * @param size the size or length of the array
 * @return if a[i] mod 2 is 0 it is even, returns the count of all even values
 */
...
/** counts how many values are odd
 * @param a[] the array
 * @param size the size or length of the array
 * @return if a[i] mod 2 is 1 it is odd, returns the count of all odd values
 */
...
/** counts how many values are divisible by a given value, in this case min
 * @param a[] the array
 * @param size the size or length of the array
 * @param x the divisor or value being divided by
 * @return if a[i] mod x is 0 it is adds one to the count, returns the count
 */
